...
run('s16_edrop30', 16)                                  # best known: OOF 0.5852 / human 0.6168
run('s16_edrop45', 16, edrop=0.45)                      # the combination under test
run('s16_edrop55', 16, edrop=0.55)                      # is more dropout better still?
run('s16_edrop45_pdrop25', 16, edrop=0.45, pdrop=0.25)
run('s24_edrop45', 24, edrop=0.45)                      # does the seed curve keep paying?
json.dump(RES, open(f'{ART}/metrics.json', 'w'), indent=2)
